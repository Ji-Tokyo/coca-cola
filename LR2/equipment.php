...
<body>
    ...
    <div class="container">
        <form action="" id="form" method="POST" class="mt-5 mb-5">
                ...
                <select type="text" name="type" class="w-100 form-select mb-3">
                    ...
                    <?php 
                        foreach($types as $type) {
                            ?>
                                <option value="<?php echo htmlspecialchars($type['id']) ?>" <?php save_sel($type['id']) ?>><?php echo htmlspecialchars($type['type_name']) ?></option>
                            <?php
                        }
                    ?>
                </select>
        ...
        <tbody>
            <?php
                foreach($data as $items) {
                    ?>
                    <tr>
                        <td><img src="img/<?= htmlspecialchars($items['img_path']) ?>" class="w-100"></td>
                        <td><?= htmlspecialchars($items['name']) ?></td>
                        <td><?= htmlspecialchars($items['type_name']) ?></td>
                        <td><?= htmlspecialchars($items['description']) ?></td>
                        <td><?= htmlspecialchars($items['cost']) ?></td>
                    </tr>
                    <?php
                }
            ?>
